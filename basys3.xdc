...
# set_property CLOCK_DEDICATED_ROUTE FALSE [get_clocks clk_pre]
...
set_property IOSTANDARD LVCMOS33 [get_ports disp_7seg]

set_property PACKAGE_PIN R2 [get_ports T1]
set_property IOSTANDARD LVCMOS33 [get_ports T1]
set_property PACKAGE_PIN T1 [get_ports T0]
set_property IOSTANDARD LVCMOS33 [get_ports T0]

set_property PACKAGE_PIN V17 [get_ports reset]
set_property IOSTANDARD LVCMOS33 [get_ports reset]

set_property PACKAGE_PIN U16 [get_ports success_led]
